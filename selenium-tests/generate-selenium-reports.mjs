...
const testCases = [
  ...
  { testId: 'TC-DASH-028', module: 'Dashboard', feature: 'Recent Documents Table', name: 'Verify priority indicator warning star', desc: 'Ensure priority flag document cards in main grid view display prominent star icon overlay.' },
